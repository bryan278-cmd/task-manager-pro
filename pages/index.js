  ...
  return (
    <div style={{
      ...
      <button
        ...
        onMouseEnter={(e) => { if (!isCompleted) e.currentTarget.style.backgroundColor = "#4B5EAA"; }}
        onMouseLeave={(e) => { if (!isCompleted) e.currentTarget.style.backgroundColor = "#0070f3"; }}
      >
...
export default function Home() {
  ...
  return (
    <main style={{ maxWidth: 720, margin: "40px auto", fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Arial" }}>
      ...
      {tasks.map((t, i) => (
        <TaskCard key={i} title={t} onComplete={() => console.log(`${t} completed!`)} />
      ))}
    </main>
  );
}
